    ...
    <nav className="site-nav">
      <div className="nav-inner">
        ...
        <div className="nav-links">
          ...
          {user ? (
            <>
              <Link to="/challenges" className="nav-link">Desafíos</Link>
              <Link to="/matches" className="nav-link">Partidos</Link>
              <Link to="/profile" className="nav-link">Mi perfil</Link>
              <button onClick={out} className="nav-link nav-out">Salir</button>
            </>
          ) : (
            <>
              <Link to="/login" className="nav-link">Ingresar</Link>
              <Link to="/register" className="nav-link nav-cta">Registrarme</Link>
            </>
          )}
        </div>
      </div>
